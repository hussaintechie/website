...
const Navbar = () => {
  ...
  const segments = [
    { name: "Hire a Call Boy", href: "/services/hireCallBoyPage" },
    { name: "Hire a Call Girl", href: "/services/hirecallgirl" },
    { name: "Join as call girl", href: "/services/callgirl" },
    { name: "Join as call boy", href: "/services/jioncallboy" }
