        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-12 md:gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            <h3 className="text-white text-xl font-black mb-4 tracking-tight">
             call boy and girl<br/><span className="text-red-600">service </span>
            </h3>
            <p className="text-sm leading-relaxed text-slate-400">
              A fast growing agency company, building trust through reliable service and  India since 2015.
            </p>
          </div>
          ...
          <div>
            <h4 className="text-white font-bold mb-4 border-b border-red-600 w-fit pb-1 uppercase tracking-wider text-sm">Our service</h4>
            <ul className="space-y-3 text-sm">
              <li><Link href="/services/hireCallBoyPage" className="hover:text-red-500 transition-colors">hire an call boy</Link></li>
              <li><Link href="/services/hirecallgirl" className="hover:text-red-500 transition-colors">hire a call girl</Link></li>
              <li><Link href="/services/callgirl" className="hover:text-red-500 transition-colors">Join as call girl </Link></li>
              <li><Link href="/services/jioncallboy" className="hover:text-red-500 transition-colors">Join as call boy</Link></li>
            </ul>
          </div>
    ...
    all._types_of_services
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-xs text-slate-500">
            © {new Date().getFullYear()} call boy and service. All Rights Reserved.
          </p>
