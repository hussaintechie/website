...
export default function HomePage() {
  ...
  const banners = [
    { 
      id: 1, 
      title: "fullfill ur dream with us", 
      sub: "get ur dream girl at your doorstep",
      desktopImg: "/banner/test.png", // Wide image
      mobileImg: "/banner/test.png" // Tall image
    },
    // { 
    //   id: 2, 
  ...
  const serviceData = [
    { id: 1, title: "hire a call boy", desc: "Hire ur  partner AND get satisfied.", img: "/serviceimage/hirecallboy.jpg", colSpan: "lg:col-span-1", link: "/services/hireCallBoyPage" },
    { id: 2, title: "hire a call girl", desc: "get ur dream girl at your doorstep", img: "/serviceimage/callgirl.jpg", colSpan: "lg:col-span-1", link: "/services/hirecallgirl" },
    { id: 3, title: "join as an call boy", desc: "Join our network and earn great income.", img: "/serviceimage/callboy.webp", colSpan: "lg:col-span-1", link: "/services/jioncallboy" },
    { id: 4, title: "join as an call girl", desc: "Join our network and earn great income.", img: "/serviceimage/callgirl.jpg", colSpan: "lg:col-span-1", link: "/services/callgirl" },
     ];
  const reviews = [
    { id: 1, name: "Anu Priya", time: "1 months ago", text: "Great service! Highly recommended.", initial: "P" },
    { id: 2, name: "sanjay kumar", time: "2 months ago", text: "Excellent service! Will definitely recommend.", initial: "P" },
    { id: 3, name: "gopal", time: "1 month ago", text: "Excellent call girl and very professional.", initial: "E" },
    { id: 4, name: "pavithra", time: "2 months ago", text: "Very satisfied with the service.", initial: "S" },
    { id: 5, name: "Rajesh Chen", time: "4 months ago", text: "Outstanding service and support.", initial: "R" },
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            <div>
              ...
              < span className="text-blue-600"> call boy &  </span> <span className="text-red-600">girl</span> <span className="text-slate-900">service </span>
              </h2>
            </div>

            <p className="text-slate-600 text-[15px] md:text-base leading-relaxed font-medium">
              Trusted Call Boy and Girl Service all over India 
             </p>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <p className="text-slate-700 text-sm font-medium"><strong className="text-slate-900">Earning:</strong> Earn ₹15,000 – ₹20,000 per Day</p>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <p className="text-slate-700 text-sm font-medium"><strong className="text-slate-900">timing :</strong>Part-time & full-time positions available.</p>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <p className="text-slate-700 text-sm font-medium"><strong className="text-slate-900">location of customers:</strong> Jobs within 5–10 km of your location.</p>
              </div>
            </div>
      ...
      <div className="relative z-10 flex-1 flex flex-col">
        ...
        <div className="mb-6">
          ...
          <p className="text-slate-500 text-sm font-medium">
            Get an instant response. Request a callback from our team and we'll get back to you within 24 hours.
          </p>
        </div>
